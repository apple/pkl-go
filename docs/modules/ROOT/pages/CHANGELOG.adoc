...
[IMPORTANT]
====
This release removes the `pkl-gen-go` binary and replaces it with a new xref:main:pkl-cli:index.adoc#cli-tools[`pkl:Command`]-based tool `@pkl.go/gen.pkl` (pr:https://github.com/apple/pkl-go/pull/209[]).
