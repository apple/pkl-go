...
The settings file is a Pkl file that amends module https://pkl-lang.org/package-docs/pkg.pkl-lang.org/pkl-go/pkl.golang/current/GeneratorSettings/index.html[`package://pkl.pkl-lang.org/pkl-go/pkl.golang@<VERSION>#/GeneratorSettings.pkl`].
